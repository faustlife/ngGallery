(function () {
    ...
    function ngGallery($document, $timeout, $q, $templateCache) {
        ...
        $templateCache.put(template_url,
            ...
            '  <a class="close-popup" ng-click="closeGallery()"><md-icon style="color: #ffffff;">close</md-icon></a>' +
            '  <a class="nav-left" ng-click="prevImage()"><i class="fa fa-angle-left"></i></a>' +
            '  <img ondragstart="return false;" draggable="false" ng-src="{{ img }}"  ng-show="!loading" class="effect" />' +
